...
Будьте готовы к математической неизбежности: **для каждого класса будет создано 2^N интерфейсов**, где N — это количество публичных методов.
...
- Комбинаторный взрыв: Генерация 2^N файлов для одного класса. Ваш проект станет тяжелее, солиднее и внушительнее!
